...
public record ZenCoverQuoteStaticData() implements CustomerObject, Validatable, SensitiveObject {
  public static final String TYPE = "ZenCoverQuoteStaticData";
  ...
  @Override
  public ZenCoverQuoteStaticData correct(DeploymentConfig config, ValidationErrorResolver resolver) {
    return this;
  }

  @Override
  public ZenCoverQuoteStaticData applyAvailabilityRemovals(Instant referenceDate) {
    ZenCoverQuoteStaticDataBuilder builder = toBuilder();

    return builder.build();
  }

  public ZenCoverQuoteStaticData maskData(DataMaskingLevel level) {
    ZenCoverQuoteStaticDataBuilder builder = toBuilder();
  ...
  public ZenCoverQuoteStaticData anonymizeData() {
    ZenCoverQuoteStaticDataBuilder builder = toBuilder();
    return builder.build();
  }

  public static ZenCoverQuoteStaticDataBuilder builder() {
    return new ZenCoverQuoteStaticDataBuilder();
  }
  public ZenCoverQuoteStaticDataBuilder toBuilder() {
    return new ZenCoverQuoteStaticDataBuilder();
  }

  public static class ZenCoverQuoteStaticDataBuilder {

    public ZenCoverQuoteStaticData build() {
      return new ZenCoverQuoteStaticData();
    }
  }
