...
public enum TransactionType implements com.socotra.coremodel.TransactionType, com.socotra.coremodel.CustomerObject {
    ...
    addItem(TransactionCategory.change, true),
    POSDiscount(TransactionCategory.change, true),
    applyDiscount(TransactionCategory.change, true),
    standardRenewal(TransactionCategory.renewal, true),
    standardCancellation(TransactionCategory.cancellation, true),
    standardReinstatement(TransactionCategory.reinstatement, true);
